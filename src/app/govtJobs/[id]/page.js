...
const page = async ({ params }) => {
  ...
  const job = await jobs.filter((job) => job._id === id)[0]
        ...
        <div className="w-full mx-auto">
          <div className="mx-auto w-full md:w-[80%] bg-white p-8">
            <div className="md:flex justify-between items-center mb-6">
              <div className=" w-full h-64 md:w-[50%] rounded-md overflow-hidden relative">
                <Image src={job?.image} alt="image" fill style={{ objectFit: 'contain', borderRadius: '6px' }} />
              </div>
              <div className={`w-full md:w-[50%] pt-8 md:pt-0 md:pl-8 space-y-5 font-playfair text-3xl lg:text-[2.875rem]/[3.25rem] text-[#202628] font-bold text-center`}>{job?.title}</div>
            </div>
            ...
            <div className="info mb-6">
              <h2 className={`text-xl font-bold font-playfair mb-5`}>Apllication Fee</h2>
            ...
            {Object.keys(service).length === 0 ? (
              <div className="info my-6">
                ...
                <div className="flex gap-7 flex-wrap">
                  ...
                  <ApplyServiceButton currentUser={currentUser} serviceId={id} serviceType="govtJob" serviceData={job?.documetsRequired} />
                </div>
              </div>
            ) : (
              <div className="info my-6 space-y-4">
                ...
                <div className="">
                  <div className="h-9 w-40 py-1 px-3 bg-rose-500 rounded-md text-white text-lg font-semibold flex items-center justify-between gap-3 flex-nowrap mb-2">
